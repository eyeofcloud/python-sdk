...
from eyeofcloud import logger as _logger
...
class SimpleLoggerTests(unittest.TestCase):
    def test_log__deprecation_warning(self):
        ...
        msg = "<class 'eyeofcloud.logger.SimpleLogger'> is deprecated. " "Please use standard python loggers."
...
class AdaptLoggerTests(unittest.TestCase):
    ...
    def test_adapt_logger__simple(self):
        ...
        self.assertEqual('eyeofcloud.logger.SimpleLogger', standard_logger.name)
    ...
    def test_adapt_logger__noop(self):
        ...
        self.assertIsInstance(standard_logger, logging.Logger)
        self.assertEqual('eyeofcloud.logger.NoOpLogger', standard_logger.name)
