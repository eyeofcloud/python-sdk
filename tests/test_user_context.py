...
from eyeofcloud import eyeofcloud, decision_service
from eyeofcloud.decision.eyeofcloud_decide_option import EyeofcloudDecideOption as DecideOption
from eyeofcloud.decision.eyeofcloud_decision import EyeofcloudDecision
from eyeofcloud.helpers import enums
from eyeofcloud.eyeofcloud_user_context import EyeofcloudUserContext
...
class UserContextTest(base.BaseTest):
    ...
    def test_user_context(self):
        ...
        """
        uc = EyeofcloudUserContext(self.eyeofcloud, None, "test_user")
    ...
    def test_attributes_are_cloned_when_passed_to_user_context(self):
        ...
        uc = EyeofcloudUserContext(self.eyeofcloud, None, user_id, attributes)
    ...
    def test_attributes_default_to_dict_when_passes_as_non_dict(self):
        uc = EyeofcloudUserContext(self.eyeofcloud, None, "test_user", True)
        # user attribute should be empty dict
        self.assertEqual({}, uc.get_user_attributes())

        uc = EyeofcloudUserContext(self.eyeofcloud, None, "test_user", 10)
        # user attribute should be empty dict
        self.assertEqual({}, uc.get_user_attributes())

        uc = EyeofcloudUserContext(self.eyeofcloud, None, "test_user", 'helloworld')
        # user attribute should be empty dict
        self.assertEqual({}, uc.get_user_attributes())
    ...
    def test_user_context_is_cloned_when_passed_to_eyeofcloud_APIs(self):
    ...
    def test_decide__SDK_not_ready(self):
        ...
        self.assertIn(
            'Eyeofcloud SDK not configured properly yet.',
            actual.reasons
        )
    ...
    def test_decide__feature_test(self):
        ...
        with mock.patch(
            ...
            'eyeofcloud.eyeofcloud.Eyeofcloud._send_impression_event'
        ) as mock_send_event:
    ...
    def test_decide_for_keys(self):
        ...
        mocked_decision_1 = EyeofcloudDecision(flag_key='test_feature_in_experiment', enabled=True)
        mocked_decision_2 = EyeofcloudDecision(flag_key='test_feature_in_rollout', enabled=False)
        ...
        with mock.patch(
            'eyeofcloud.eyeofcloud.Eyeofcloud._decide', side_effect=side_effect
        ) as mock_decide, mock.patch(
            'eyeofcloud.eyeofcloud_user_context.EyeofcloudUserContext._clone',
    ...
    def test_decide_for_keys__default_options__with__options(self):
        ...
        with mock.patch(
            'eyeofcloud.eyeofcloud.Eyeofcloud._decide'
        ) as mock_decide, mock.patch(
            'eyeofcloud.eyeofcloud_user_context.EyeofcloudUserContext._clone',
            return_value=user_context
        ):
    ...
    def test_decide_for_all(self):
        ...
        with mock.patch(
            'eyeofcloud.eyeofcloud.Eyeofcloud._decide_for_keys', return_value='response from decide_for_keys'
        ) as mock_decide, mock.patch(
            'eyeofcloud.eyeofcloud_user_context.EyeofcloudUserContext._clone',
            return_value=user_context
        ):
    ...
    def test_decide_options_bypass_UPS(self):
        ...
        ups = Ups()
        opt_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict_with_features), user_profile_service=ups)
        project_config = opt_obj.config_manager.get_config()
    ...
    def test_init__invalid_default_decide_options(self):
        ...
        with mock.patch('eyeofcloud.logger.reset_logger', return_value=mock_client_logger):
            opt_obj = eyeofcloud.Eyeofcloud(default_decide_options=invalid_decide_options)
    ...
    def test_forced_decision_return_status__valid_datafile(self):
        ...
        context = EyeofcloudUserContext.EyeofcloudDecisionContext('test_feature_in_rollout', None)
        decision = EyeofcloudUserContext.EyeofcloudForcedDecision('211129')
    ...
    def test_should_return_valid_decision_after_setting_and_removing_forced_decision(self):
        ...
        context = EyeofcloudUserContext.EyeofcloudDecisionContext('test_feature_in_experiment', None)
        decision = EyeofcloudUserContext.EyeofcloudForcedDecision('211129')
    ...
    def test_should_return_valid_experiment_decision_after_setting_forced_decision(self):
        ...
        context = EyeofcloudUserContext.EyeofcloudDecisionContext('test_feature_in_experiment_and_rollout',
                                                                  'group_exp_2')
        decision = EyeofcloudUserContext.EyeofcloudForcedDecision('group_exp_2_variation')
    ...
    def test_should_return_valid_decision_after_setting_invalid_delivery_rule_variation_in_forced_decision(self):
        ...
        context = EyeofcloudUserContext.EyeofcloudDecisionContext('test_feature_in_rollout', '211127')
        decision = EyeofcloudUserContext.EyeofcloudForcedDecision('invalid')
    ...
    def test_should_return_valid_decision_after_setting_invalid_experiment_rule_variation_in_forced_decision(self):
        ...
        context = EyeofcloudUserContext.EyeofcloudDecisionContext('test_feature_in_experiment',
                                                                  'test_experiment')
        decision = EyeofcloudUserContext.EyeofcloudForcedDecision('invalid')
    ...
    def test_conflicts_return_valid_decision__forced_decision(self):
        ...
        context_with_flag = EyeofcloudUserContext.EyeofcloudDecisionContext('test_feature_in_rollout', None)
        decision_for_flag = EyeofcloudUserContext.EyeofcloudForcedDecision('211129')

        context_with_rule = EyeofcloudUserContext.EyeofcloudDecisionContext('test_feature_in_rollout', '211127')
        decision_for_rule = EyeofcloudUserContext.EyeofcloudForcedDecision('211229')
    ...
    def test_get_forced_decision_return_valid_decision__forced_decision(self):
        ...
        context_with_flag_1 = EyeofcloudUserContext.EyeofcloudDecisionContext('f1', None)
        decision_for_flag_1 = EyeofcloudUserContext.EyeofcloudForcedDecision('v1')

        context_with_flag_2 = EyeofcloudUserContext.EyeofcloudDecisionContext('f1', None)
        decision_for_flag_2 = EyeofcloudUserContext.EyeofcloudForcedDecision('v2')
        ...
        context_with_rule_1 = EyeofcloudUserContext.EyeofcloudDecisionContext('f1', 'r1')
        decision_for_rule_1 = EyeofcloudUserContext.EyeofcloudForcedDecision('v3')

        context_with_rule_2 = EyeofcloudUserContext.EyeofcloudDecisionContext('f1', 'r2')
        decision_for_rule_2 = EyeofcloudUserContext.EyeofcloudForcedDecision('v4')
    ...
    def test_forced_decision_clone_return_valid_forced_decision(self):
        ...
        context_with_flag = EyeofcloudUserContext.EyeofcloudDecisionContext('f1', None)
        decision_for_flag = EyeofcloudUserContext.EyeofcloudForcedDecision('v1')
        context_with_rule = EyeofcloudUserContext.EyeofcloudDecisionContext('f1', 'r1')
        decision_for_rule = EyeofcloudUserContext.EyeofcloudForcedDecision('v2')
        context_with_empty_rule = EyeofcloudUserContext.EyeofcloudDecisionContext('f1', '')
        decision_for_empty_rule = EyeofcloudUserContext.EyeofcloudForcedDecision('v3')
        ...
        context_with_rule = EyeofcloudUserContext.EyeofcloudDecisionContext('x', 'y')
        decision_for_rule = EyeofcloudUserContext.EyeofcloudForcedDecision('z')
        user_context.set_forced_decision(context_with_rule, decision_for_rule)
    ...
    def test_forced_decision_sync_return_correct_number_of_calls(self):
        ...
        opt_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict_with_features))
        user_context = opt_obj.create_user_context("test_user", {})
        context_1 = EyeofcloudUserContext.EyeofcloudDecisionContext('f1', None)
        decision_1 = EyeofcloudUserContext.EyeofcloudForcedDecision('v1')
        context_2 = EyeofcloudUserContext.EyeofcloudDecisionContext('f2', None)
        decision_2 = EyeofcloudUserContext.EyeofcloudForcedDecision('v1')

        with mock.patch(
            'eyeofcloud.eyeofcloud_user_context.EyeofcloudUserContext.set_forced_decision'
        ) as set_forced_decision_mock, mock.patch(
            'eyeofcloud.eyeofcloud_user_context.EyeofcloudUserContext.get_forced_decision'
        ) as get_forced_decision_mock, mock.patch(
            'eyeofcloud.eyeofcloud_user_context.EyeofcloudUserContext.remove_forced_decision'
        ) as remove_forced_decision_mock, mock.patch(
            'eyeofcloud.eyeofcloud_user_context.EyeofcloudUserContext.remove_all_forced_decisions'
