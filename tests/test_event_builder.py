# Copyright 2016-2019, Eyeofcloud
...
class EventBuilderTest(base.BaseTest):
    def setUp(self, *args, **kwargs):
        ...
        self.event_builder = self.eyeofcloud.event_builder
    ...
    creates Event object with only those attributes for which is_attribute_valid is True."""
        ...
        with mock.patch('time.time', return_value=42.123), mock.patch(
            'uuid.uuid4', return_value='a68cf1ad-0393-4e18-af87-efe8f01a7c9c'
        ), mock.patch('eyeofcloud.helpers.validator.is_attribute_valid', side_effect=side_effect):
