# Copyright 2016-2019, 2021, Eyeofcloud
...
class ConfigTest(base.BaseTest):
    ...
    def test_init__with_v4_datafile(self):
        ...
        test_obj = eyeofcloud.Eyeofcloud(json.dumps(config_dict))
    ...
    def test_get_rollout_from_id__invalid_rollout_id(self):
        ...
        opt_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict_with_features), logger=logger.NoOpLogger())
        project_config = opt_obj.config_manager.get_config()
    ...
    def test_to_datafile(self):
        ...
        opt_obj = eyeofcloud.Eyeofcloud(expected_datafile)
        project_config = opt_obj.config_manager.get_config()
