# Copyright 2017-2021, Eyeofcloud
...
from eyeofcloud import eyeofcloud_user_context
...
class DecisionServiceTest(base.BaseTest):
    def setUp(self):
        ...
        self.decision_service = self.eyeofcloud.decision_service
    ...
    def test_get_whitelisted_variation__user_in_invalid_variation(self):
        ...
        experiment = self.project_config.get_experiment_from_key("test_experiment")
        with mock.patch(
                "eyeofcloud.project_config.ProjectConfig.get_variation_from_key",
                return_value=None,
    ...
    def test_get_variation__experiment_not_running(self):
        ...
        user = eyeofcloud_user_context.EyeofcloudUserContext(eyeofcloud_client=None,
                                                             logger=None,
                                                             user_id="test_user",
                                                             user_attributes={})
        experiment = self.project_config.get_experiment_from_key("test_experiment")
        ...
        with mock.patch(
                "eyeofcloud.decision_service.DecisionService.get_forced_variation"
            ...
            "eyeofcloud.user_profile.UserProfileService.lookup"
        ) as mock_lookup, mock.patch(
            "eyeofcloud.user_profile.UserProfileService.save"
        ) as mock_save:
    ...
    def test_get_variation__user_whitelisted_for_variation(self):
        ...
        user = eyeofcloud_user_context.EyeofcloudUserContext(eyeofcloud_client=None, logger=None,
                                                             user_id="test_user",
                                                             user_attributes={})
        experiment = self.project_config.get_experiment_from_key("test_experiment")
        with mock.patch(
                "eyeofcloud.decision_service.DecisionService.get_whitelisted_variation",
    ...
    def test_get_variation__user_profile_save_fails(self):
        ...
        with mock.patch.object(
            ...
            "eyeofcloud.user_profile.UserProfileService.lookup", return_value=None
        ) as mock_lookup, mock.patch(
            "eyeofcloud.user_profile.UserProfileService.save",
            side_effect=Exception("major problem"),
        ) as mock_save:
...
class FeatureFlagDecisionTests(base.BaseTest):
    ...
    for the experiment, then it skips to the Everyone Else rule. """
        ...
        with mock.patch(
            ...
            "eyeofcloud.bucketer.Bucketer.bucket", side_effect=[[None, []], [variation_to_mock, []]]
        ):
            variation_received, _ = self.decision_service.get_variation_for_rollout(
                self.project_config, feature, user
            )
    ...
    def test_get_variation_for_feature__returns_variation_for_feature_in_rollout(self):
        ...
        get_variation_for_rollout_patch = mock.patch(
            "eyeofcloud.decision_service.DecisionService.get_variation_for_rollout",
    ...
    def test_get_variation_for_feature__returns_variation_if_user_not_in_experiment_but_in_rollout(
        ...
        with mock.patch(
                ...
                self.mock_decision_logger as mock_decision_service_logging, mock.patch(
                "eyeofcloud.bucketer.Bucketer.bucket", return_value=[expected_variation, []]):
    ...
    def test_get_variation_for_feature__returns_variation_for_feature_in_mutex_group_bucket_less_than_2500(
        ...
        with mock.patch(
            'eyeofcloud.bucketer.Bucketer._generate_bucket_value', return_value=2400) as mock_generate_bucket_value, \
    ...
    def test_get_variation_for_feature__returns_variation_for_feature_in_mutex_group_bucket_range_2500_5000(
        ...
        with mock.patch(
            'eyeofcloud.bucketer.Bucketer._generate_bucket_value', return_value=4000) as mock_generate_bucket_value, \
                mock.patch.object(self.project_config, 'logger') as mock_config_logging:
            variation_received, _ = self.decision_service.get_variation_for_feature(
                self.project_config, feature, user
            )
    ...
    def test_get_variation_for_feature__returns_variation_for_feature_in_mutex_group_bucket_range_5000_7500(
        ...
        with mock.patch(
            'eyeofcloud.bucketer.Bucketer._generate_bucket_value', return_value=6500) as mock_generate_bucket_value, \
                mock.patch.object(self.project_config, 'logger') as mock_config_logging:
            variation_received, _ = self.decision_service.get_variation_for_feature(
                self.project_config, feature, user
            )
    ...
    def test_get_variation_for_feature__returns_variation_for_rollout_in_mutex_group_bucket_greater_than_7500(
        ...
        with mock.patch(
            'eyeofcloud.bucketer.Bucketer._generate_bucket_value', return_value=8000) as mock_generate_bucket_value, \
                mock.patch.object(self.project_config, 'logger') as mock_config_logging:
            variation_received, _ = self.decision_service.get_variation_for_feature(
                self.project_config, feature, user
            )
