# Copyright 2020-2021, Eyeofcloud
...
from eyeofcloud import eyeofcloud, project_config
from eyeofcloud import eyeofcloud_config
from . import base


class EyeofcloudConfigTest(base.BaseTest):
    def setUp(self):
        base.BaseTest.setUp(self)
        opt_instance = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict_with_features))
        self.project_config = opt_instance.config_manager.get_config()
        self.opt_config_service = eyeofcloud_config.EyeofcloudConfigService(self.project_config)
    ...
    def test__get_config(self):
        """ Test that get_config returns an expected instance of EyeofcloudConfig. """

        self.assertIsInstance(self.actual_config, eyeofcloud_config.EyeofcloudConfig)
    ...
    def test__get_config__invalid_project_config(self):
        ...
        opt_service = eyeofcloud_config.EyeofcloudConfigService({"key": "invalid"})
    ...
    def test__get_experiments_maps(self):
        ...
        for exp in actual_key_map.values():
            self.assertIsInstance(exp, eyeofcloud_config.EyeofcloudExperiment)
    ...
    def test__get_features_map(self):
        ...
        for feat in actual_feature_map.values():
            self.assertIsInstance(feat, eyeofcloud_config.EyeofcloudFeature)
    ...
    def test__get_variations_map(self):
        ...
        for variation in actual_variations_map.values():
            self.assertIsInstance(variation, eyeofcloud_config.EyeofcloudVariation)
    ...
    def test__get_variables_map(self):
        ...
        for variable in actual_variables_map.values():
            self.assertIsInstance(variable, eyeofcloud_config.EyeofcloudVariable)
    ...
    def test__get_sdk_key(self):
        ...
        config = eyeofcloud_config.EyeofcloudConfig(
            revision='101',
            experiments_map={},
            features_map={},
            sdk_key='testSdkKey',
    ...
    def test_get_audiences(self):
        ...
        config_service = eyeofcloud_config.EyeofcloudConfigService(proj_conf)

        for audience in config_service.audiences:
            self.assertIsInstance(audience, eyeofcloud_config.EyeofcloudAudience)
    ...
    def test_stringify_audience_conditions_all_cases(self):
        ...
        config_service = eyeofcloud_config.EyeofcloudConfigService(config)
    ...
    def test_eyeofcloud_audience_conversion(self):
    ...
    def test_get_variations_from_experiments_map(self):
        ...
        eoc_experiment = experiments_id_map['10420810910']

        for variation in eoc_experiment.variations_map.values():
            self.assertIsInstance(variation, eyeofcloud_config.EyeofcloudVariation)
    ...
    def test_get_delivery_rules(self):
        ...
        for eoc_feature in actual_features_map.values():
            self.assertIsInstance(eoc_feature, eyeofcloud_config.EyeofcloudFeature)
            for delivery_rule in eoc_feature.delivery_rules:
                self.assertIsInstance(delivery_rule, eyeofcloud_config.EyeofcloudExperiment)
