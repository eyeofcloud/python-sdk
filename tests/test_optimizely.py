# Copyright 2016-2021, Eyeofcloud
...
from eyeofcloud import decision_service
from eyeofcloud import entities
from eyeofcloud import error_handler
from eyeofcloud import event_builder
from eyeofcloud import exceptions
from eyeofcloud import logger
...
from eyeofcloud.event.event_factory import EventFactory
from eyeofcloud.helpers import enums
from . import base


class EyeofcloudTest(base.BaseTest):
    strTest = None
    ...
    def test_init__invalid_datafile__logs_error(self):
        ...
        with mock.patch('eyeofcloud.logger.reset_logger', return_value=mock_client_logger):
            opt_obj = eyeofcloud.Eyeofcloud('invalid_datafile')
    ...
    def test_init__null_datafile__logs_error(self):
        ...
        mock_client_logger = mock.MagicMock()
        with mock.patch('eyeofcloud.logger.reset_logger', return_value=mock_client_logger):
            opt_obj = eyeofcloud.Eyeofcloud(None)
    ...
    def test_init__invalid_config_manager__logs_error(self):
        ...
        mock_client_logger = mock.MagicMock()
        with mock.patch('eyeofcloud.logger.reset_logger', return_value=mock_client_logger):
            opt_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict), config_manager=InvalidConfigManager())
    ...
    def test_init__invalid_event_dispatcher__logs_error(self):
        ...
        mock_client_logger = mock.MagicMock()
        with mock.patch('eyeofcloud.logger.reset_logger', return_value=mock_client_logger):
            opt_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict), event_dispatcher=InvalidDispatcher)
    ...
    def test_init__invalid_event_processor__logs_error(self):
        ...
        mock_client_logger = mock.MagicMock()
        with mock.patch('eyeofcloud.logger.reset_logger', return_value=mock_client_logger):
            opt_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict), event_processor=InvalidProcessor)
    ...
    def test_init__invalid_logger__logs_error(self):
        ...
        mock_client_logger = mock.MagicMock()
        with mock.patch('eyeofcloud.logger.reset_logger', return_value=mock_client_logger):
            opt_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict), logger=InvalidLogger)
    ...
    def test_init__invalid_error_handler__logs_error(self):
        ...
        mock_client_logger = mock.MagicMock()
        with mock.patch('eyeofcloud.logger.reset_logger', return_value=mock_client_logger):
            opt_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict), error_handler=InvalidErrorHandler)
    ...
    def test_init__unsupported_datafile_version__logs_error(self):
        ...
        mock_client_logger = mock.MagicMock()
        with mock.patch('eyeofcloud.logger.reset_logger', return_value=mock_client_logger), mock.patch(
                'eyeofcloud.error_handler.NoOpErrorHandler.handle_error'
        ) as mock_error_handler:
            opt_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict_with_unsupported_version))
    ...
    def test_init_with_supported_datafile_version(self):
        ...
        mock_client_logger = mock.MagicMock()
        with mock.patch('eyeofcloud.logger.reset_logger', return_value=mock_client_logger):
            opt_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict))
    ...
    def test_init__datafile_only(self):
        ...
        opt_obj = eyeofcloud.Eyeofcloud(datafile=json.dumps(self.config_dict))
    ...
    def test_init__sdk_key_only(self):
        ...
        with mock.patch('eyeofcloud.config_manager.PollingConfigManager._set_config'), mock.patch(
                'threading.Thread.start'
        ):
            opt_obj = eyeofcloud.Eyeofcloud(sdk_key='test_sdk_key')
    ...
    def test_init__sdk_key_and_datafile(self):
        ...
        with mock.patch('eyeofcloud.config_manager.PollingConfigManager._set_config'), mock.patch(
            ...
            opt_obj = eyeofcloud.Eyeofcloud(datafile=json.dumps(self.config_dict), sdk_key='test_sdk_key')
    ...
    def test_init__sdk_key_and_datafile_access_token(self):
        ...
        with mock.patch('eyeofcloud.config_manager.AuthDatafilePollingConfigManager._set_config'), mock.patch(
                'threading.Thread.start'
        ):
            opt_obj = eyeofcloud.Eyeofcloud(datafile_access_token='test_datafile_access_token', sdk_key='test_sdk_key')
    ...
    def test_invalid_json_raises_schema_validation_off(self):
        ...
        with mock.patch('eyeofcloud.logger.reset_logger', return_value=mock_client_logger), mock.patch(
            ...
            opt_obj = eyeofcloud.Eyeofcloud('invalid_json', skip_json_validation=True)
    ...
    def test_activate(self):
        ...
        with mock.patch(
                'eyeofcloud.decision_service.DecisionService.get_variation',
            ...
            'eyeofcloud.event.event_processor.ForwardingEventProcessor.process'
        ) as mock_process:
            self.assertEqual('variation', self.eyeofcloud.activate('test_experiment', 'test_user'))
        ...
        log_event = EventFactory.create_log_event(mock_process.call_args[0][0], self.eyeofcloud.logger)
        ...
        self._validate_event_object(
            log_event.__dict__,
            'https://logx.eyeofcloud.com/v1/events',
            expected_params,
            'POST',
    ...
    def test_add_activate_remove_clear_listener(self):
        ...
        notification_id = self.eyeofcloud.notification_center.add_notification_listener(
            enums.NotificationTypes.ACTIVATE, on_activate
        )
        with mock.patch(
                'eyeofcloud.decision_service.DecisionService.get_variation',
                return_value=(self.project_config.get_variation_from_id('test_experiment', '111129'), []),
        ), mock.patch('eyeofcloud.event.event_processor.ForwardingEventProcessor.process'):
            self.assertEqual('variation', self.eyeofcloud.activate('test_experiment', 'test_user'))

        self.assertEqual(True, callbackhit[0])
        self.eyeofcloud.notification_center.remove_notification_listener(notification_id)
        self.assertEqual(
            0, len(self.eyeofcloud.notification_center.notification_listeners[enums.NotificationTypes.ACTIVATE]),
        )
        self.eyeofcloud.notification_center.clear_all_notifications()
        self.assertEqual(
            0, len(self.eyeofcloud.notification_center.notification_listeners[enums.NotificationTypes.ACTIVATE]),
        )
    ...
    def test_add_track_remove_clear_listener(self):
        ...
        note_id = self.eyeofcloud.notification_center.add_notification_listener(enums.NotificationTypes.TRACK, on_track)

        with mock.patch(
                'eyeofcloud.decision_service.DecisionService.get_variation',
                return_value=(self.project_config.get_variation_from_id('test_experiment', '111129'), []),
        ), mock.patch('eyeofcloud.event.event_processor.ForwardingEventProcessor.process'):
            self.eyeofcloud.track('test_event', 'test_user')

        self.assertEqual(True, callback_hit[0])

        self.assertEqual(
            1, len(self.eyeofcloud.notification_center.notification_listeners[enums.NotificationTypes.TRACK]),
        )
        self.eyeofcloud.notification_center.remove_notification_listener(note_id)
        self.assertEqual(
            0, len(self.eyeofcloud.notification_center.notification_listeners[enums.NotificationTypes.TRACK]),
        )
        self.eyeofcloud.notification_center.clear_all_notifications()
        self.assertEqual(
            0, len(self.eyeofcloud.notification_center.notification_listeners[enums.NotificationTypes.TRACK]),
    ...
    def test_activate_and_decision_listener(self):
        ...
        self.eyeofcloud.notification_center.add_notification_listener(enums.NotificationTypes.ACTIVATE, on_activate)
        variation = (self.project_config.get_variation_from_id('test_experiment', '111129'), [])

        with mock.patch(
                'eyeofcloud.decision_service.DecisionService.get_variation',
                return_value=variation,
        ), mock.patch('eyeofcloud.event.event_processor.ForwardingEventProcessor.process') as mock_process, mock.patch(
            'eyeofcloud.notification_center.NotificationCenter.send_notifications'
        ) as mock_broadcast:
            self.assertEqual('variation', self.eyeofcloud.activate('test_experiment', 'test_user'))
    ...
    def test_activate_and_decision_listener_with_attr(self):
        ...
        with mock.patch(
            ...
            self.assertEqual(
                'variation', self.eyeofcloud.activate('test_experiment', 'test_user', {'test_attribute': 'test_value'}),
            )
    ...
    when user not in experiment. """
        ...
        with mock.patch('eyeofcloud.decision_service.DecisionService.get_variation',
                        return_value=(None, []), ), mock.patch(
            'eyeofcloud.event.event_processor.ForwardingEventProcessor.process'
        ), mock.patch(
            'eyeofcloud.notification_center.NotificationCenter.send_notifications'
        ) as mock_broadcast_decision:
            self.assertEqual(None, self.eyeofcloud.activate('test_experiment', 'test_user'))
    ...
    def test_track_listener(self):
        ...
        self.eyeofcloud.notification_center.add_notification_listener(enums.NotificationTypes.TRACK, on_track)
    ...
    def test_track_listener_with_attr(self):
        ...
        with mock.patch(
            ...
            self.eyeofcloud.track('test_event', 'test_user', attributes={'test_attribute': 'test_value'})
    ...
    Also confirm that impression event is processed. """
        ...
        opt_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict_with_features))
        ...
        with mock.patch(
            'eyeofcloud.decision_service.DecisionService.get_variation_for_feature',
                return_value=(
                    decision_service.Decision(mock_experiment, mock_variation, enums.DecisionSources.FEATURE_TEST), []),
        ) as mock_decision, mock.patch('eyeofcloud.event.event_processor.ForwardingEventProcessor.process'):
    ...
    variation when different types of attributes are provided and audience conditions are met. """
        ...
        with mock.patch(
            'eyeofcloud.bucketer.Bucketer.bucket',
                return_value=(self.project_config.get_variation_from_id('test_experiment', '111129'), []),
            ...
            self.assertEqual(
                'variation', self.eyeofcloud.activate('test_experiment', 'test_user', attributes),
            )
    ...
    variation when attributes are provided and typed audience conditions are met. """
        opt_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict_with_typed_audiences))

        with mock.patch('eyeofcloud.event.event_processor.ForwardingEventProcessor.process') as mock_process:
    ...
    set_forced_variation is called. """
        ...
        with mock.patch('time.time', return_value=42), mock.patch(
                'uuid.uuid4', return_value='a68cf1ad-0393-4e18-af87-efe8f01a7c9c'
        ), mock.patch('eyeofcloud.event.event_processor.ForwardingEventProcessor.process') as mock_process:
            self.assertTrue(self.eyeofcloud.set_forced_variation('test_experiment', 'test_user', 'control'))
            self.assertEqual(
                'control', self.eyeofcloud.activate('test_experiment', 'test_user', {'test_attribute': 'test_value'}),
            )
    ...
    def test_activate__with_attributes__no_audience_match(self):
        ...
        with mock.patch('eyeofcloud.helpers.audience.does_user_meet_audience_conditions',
                        return_value=(False, [])) as mock_audience_check:
            self.assertIsNone(
                self.eyeofcloud.activate('test_experiment', 'test_user', attributes={'test_attribute': 'test_value'}, )
            )
    ...
    def test_activate__with_attributes__invalid_attributes(self):
        ...
        with mock.patch('eyeofcloud.bucketer.Bucketer.bucket') as mock_bucket, mock.patch(
                'eyeofcloud.event.event_processor.ForwardingEventProcessor.process'
        ) as mock_process:
            self.assertIsNone(self.eyeofcloud.activate('test_experiment', 'test_user', attributes='invalid'))
    ...
    def test_activate__experiment_not_running(self):
        ...
        with mock.patch(
                'eyeofcloud.helpers.audience.does_user_meet_audience_conditions', return_value=True
        ) as mock_audience_check, mock.patch(
            'eyeofcloud.helpers.experiment.is_experiment_running', return_value=False
    ...
    def test_activate__whitelisting_overrides_audience_check(self):
        ...
        with mock.patch(
                'eyeofcloud.helpers.audience.does_user_meet_audience_conditions', return_value=False
        ) as mock_audience_check, mock.patch(
            'eyeofcloud.helpers.experiment.is_experiment_running', return_value=True
        ) as mock_is_experiment_running:
            self.assertEqual('control', self.eyeofcloud.activate('test_experiment', 'user_1'))
        mock_is_experiment_running.assert_called_once_with(
            self.project_config.get_experiment_from_key('test_experiment')
        )
        self.assertEqual(0, mock_audience_check.call_count)
    ...
    def test_activate__bucketer_returns_none(self):
        ...
        with mock.patch(
            'eyeofcloud.helpers.audience.does_user_meet_audience_conditions',
    ...
    def test_activate__invalid_object(self):
        """ Test that activate logs error if Eyeofcloud instance is invalid. """
        ...
        mock_client_logging.error.assert_called_once_with('Eyeofcloud instance is not valid. Failing "activate".')
    ...
    def test_activate__invalid_config(self):
        ...
        mock_client_logging.error.assert_called_once_with(
            'Invalid config. Eyeofcloud instance is not valid. ' 'Failing "activate".'
        )
    ...
    def test_track__with_attributes__invalid_attributes(self):
        ...
        with mock.patch('eyeofcloud.bucketer.Bucketer.bucket') as mock_bucket, mock.patch(
            ...
            self.eyeofcloud.track('test_event', 'test_user', attributes='invalid')
    ...
    after a forced bucket. """
        ...
        with mock.patch('time.time', return_value=42), mock.patch(
            ...
            self.assertTrue(self.eyeofcloud.set_forced_variation('test_experiment', 'test_user', 'variation'))
            self.eyeofcloud.track(
                'test_event',
                'test_user',
                attributes={'test_attribute': 'test_value'},
    ...
    def test_track_invalid_event_key(self):
        ...
        with mock.patch(
                'eyeofcloud.event.event_processor.ForwardingEventProcessor.process'
        ) as mock_process, mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging:
            self.eyeofcloud.track('aabbcc_event', 'test_user')
    ...
    def test_track__whitelisted_user_overrides_audience_check(self):
        ...
        with mock.patch('time.time', return_value=42), mock.patch(
            ...
            self.eyeofcloud.track('test_event', 'user_1')

        self.assertEqual(1, mock_process.call_count)

    def test_track__invalid_object(self):
        """ Test that track logs error if Eyeofcloud instance is invalid. """
        ...
        mock_client_logging.error.assert_called_once_with('Eyeofcloud instance is not valid. Failing "track".')
    ...
    def test_track__invalid_config(self):
        ...
        mock_client_logging.error.assert_called_once_with(
            'Invalid config. Eyeofcloud instance is not valid. ' 'Failing "track".'
        )
    ...
    when exp_key is in invalid format. """
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging, mock.patch(
                'eyeofcloud.helpers.validator.is_non_empty_string', return_value=False
        ) as mock_validator:
            self.assertIsNone(self.eyeofcloud.track(99, 'test_user'))
    ...
    when user_id is in invalid format. """
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging:
            self.assertIsNone(self.eyeofcloud.track('test_event', 99))
    ...
    def test_get_variation(self):
        ...
        with mock.patch(
                'eyeofcloud.decision_service.DecisionService.get_variation',
                return_value=(self.project_config.get_variation_from_id('test_experiment', '111129'), []),
        ), mock.patch('eyeofcloud.notification_center.NotificationCenter.send_notifications') as mock_broadcast:
            variation = self.eyeofcloud.get_variation('test_experiment', 'test_user')
            self.assertEqual(
                'variation', variation,
            )
    ...
    def test_get_variation__invalid_object(self):
        """ Test that get_variation logs error if Eyeofcloud instance is invalid. """
        ...
        mock_client_logging.error.assert_called_once_with('Eyeofcloud instance is not valid. Failing "get_variation".')
    ...
    def test_get_variation__invalid_config(self):
        ...
        mock_client_logging.error.assert_called_once_with(
            'Invalid config. Eyeofcloud instance is not valid. ' 'Failing "get_variation".'
        )
    ...
    def test_get_variation_unknown_experiment_key(self):
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging:
            self.eyeofcloud.get_variation('aabbccdd', 'test_user', None)
    ...
    def test_is_feature_enabled__returns_false_for__invalid_attributes(self):
        ...
        with mock.patch.object(opt_obj, 'logger') as mock_client_logging, mock.patch(
                'eyeofcloud.helpers.validator.are_attributes_valid', return_value=False
        ) as mock_validator:
    ...
    def test_is_feature_enabled__invalid_object(self):
        """ Test that is_feature_enabled returns False and logs error if Eyeofcloud instance is invalid. """
        ...
        mock_client_logging.error.assert_called_once_with(
            'Eyeofcloud instance is not valid. Failing "is_feature_enabled".'
        )

    def test_is_feature_enabled__invalid_config(self):
        """ Test that is_feature_enabled returns False if config is invalid. """

        opt_obj = eyeofcloud.Eyeofcloud('invalid_file')

        with mock.patch.object(opt_obj, 'logger') as mock_client_logging, mock.patch(
                'eyeofcloud.event_dispatcher.EventDispatcher.dispatch_event'
        ) as mock_dispatch_event:
            self.assertFalse(opt_obj.is_feature_enabled('test_feature_in_experiment', 'user_1'))

        mock_client_logging.error.assert_called_once_with(
            'Invalid config. Eyeofcloud instance is not valid. ' 'Failing "is_feature_enabled".'
        )
    ...
    def test_get_enabled_features(self):
        ...
        with mock.patch(
                'eyeofcloud.eyeofcloud.Eyeofcloud.is_feature_enabled', side_effect=side_effect,
    ...
    and broadcasts decision for each feature. """
        ...
        with mock.patch(
                'eyeofcloud.decision_service.DecisionService.get_variation_for_feature', side_effect=side_effect,
        ), mock.patch(
            'eyeofcloud.notification_center.NotificationCenter.send_notifications'
        ) as mock_broadcast_decision:
            received_features = opt_obj.get_enabled_features('user_1')
    ...
    def test_get_enabled_features_invalid_user_id(self):
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging:
            self.assertEqual([], self.eyeofcloud.get_enabled_features(1.2))
    ...
    def test_get_enabled_features__invalid_attributes(self):
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging, mock.patch(
            ...
            self.assertEqual(
                [], self.eyeofcloud.get_enabled_features('test_user', attributes='invalid'),
            )
    ...
    def test_get_enabled_features__invalid_object(self):
        """ Test that get_enabled_features returns empty list if Eyeofcloud instance is invalid. """
        ...
        mock_client_logging.error.assert_called_once_with(
            'Eyeofcloud instance is not valid. ' 'Failing "get_enabled_features".'
        )
    ...
    def test_get_enabled_features__invalid_config(self):
        ...
        mock_client_logging.error.assert_called_once_with(
            'Invalid config. Eyeofcloud instance is not valid. ' 'Failing "get_enabled_features".'
        )
    ...
    def test_get_feature_variable__returns_none_if_unable_to_cast(self):
        ...
        with mock.patch(
            ...
            'eyeofcloud.project_config.ProjectConfig.get_typecast_value', side_effect=ValueError(),
        ), mock.patch.object(
            opt_obj, 'logger'
    ...
    def test_get_eyeofcloud_config__invalid_object(self):
        """ Test that get_eyeofcloud_config logs error if Eyeofcloud instance is invalid. """
        ...
        with mock.patch.object(opt_obj, 'logger') as mock_client_logging:
            self.assertIsNone(opt_obj.get_eyeofcloud_config())

        mock_client_logging.error.assert_called_once_with(
            'Eyeofcloud instance is not valid. Failing "get_eyeofcloud_config".')

    def test_get_eyeofcloud_config__invalid_config(self):
        """ Test that get_eyeofcloud_config logs error if config is invalid. """
        ...
        mock_client_logging.error.assert_called_once_with(
            'Invalid config. Eyeofcloud instance is not valid. ' 'Failing "get_eyeofcloud_config".'
        )

    def test_get_eyeofcloud_config_returns_instance_of_eyeofcloud_config(self):
        """ Test that get_eyeofcloud_config returns an instance of EyeofcloudConfig. """

        opt_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict_with_features))
        opt_config = opt_obj.get_eyeofcloud_config()
        self.assertIsInstance(opt_config, eyeofcloud_config.EyeofcloudConfig)

    def test_get_eyeofcloud_config_with_custom_config_manager(self):
        """ Test that get_eyeofcloud_config returns a valid instance of EyeofcloudConfig
        when a custom config manager is used. """

        some_obj = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict_with_features))
        ...
        opt_obj = eyeofcloud.Eyeofcloud(config_manager=SomeConfigManager())
        self.assertIsInstance(
            opt_obj.get_eyeofcloud_config(),
            eyeofcloud_config.EyeofcloudConfig
        )

        with mock.patch('eyeofcloud.eyeofcloud_config.EyeofcloudConfigService.get_config') as mock_opt_service:
            opt_obj = eyeofcloud.Eyeofcloud(config_manager=SomeConfigManager())
            opt_obj.get_eyeofcloud_config()
...
class EyeofcloudWithExceptionTest(base.BaseTest):
    def setUp(self):
        base.BaseTest.setUp(self)
        self.eyeofcloud = eyeofcloud.Eyeofcloud(
...
class EyeofcloudWithLoggingTest(base.BaseTest):
    def setUp(self):
        base.BaseTest.setUp(self)
        self.eyeofcloud = eyeofcloud.Eyeofcloud(json.dumps(self.config_dict), logger=logger.SimpleLogger())
        self.project_config = self.eyeofcloud.config_manager.get_config()
    ...
    def test_activate(self):
        ...
        with mock.patch(
            ...
            self.assertEqual(variation_key, self.eyeofcloud.activate(experiment_key, user_id))
    ...
    def test_track(self):
        ...
        mock_client_logger = mock.patch.object(self.eyeofcloud, 'logger')

        event_builder.Event('logx.eyeofcloud.com', {'event_key': event_key})
        with mock.patch(
                'eyeofcloud.event.event_processor.ForwardingEventProcessor.process'
        ), mock_client_logger as mock_client_logging:
            self.eyeofcloud.track(event_key, user_id)
    ...
    def test_activate__experiment_not_running(self):
        ...
        mock_client_logger = mock.patch.object(self.eyeofcloud, 'logger')
        mock_decision_logger = mock.patch.object(self.eyeofcloud.decision_service, 'logger')
    ...
    def test_track__invalid_attributes(self):
        ...
        mock_logger = mock.patch.object(self.eyeofcloud, 'logger')
    ...
    def test_track__invalid_event_tag(self):
        ...
        with mock_client_logger as mock_client_logging:
            self.eyeofcloud.track('test_event', 'test_user', event_tags='4200')
    ...
    def test_get_variation__invalid_attributes(self):
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging:
            self.eyeofcloud.get_variation('test_experiment', 'test_user', attributes='invalid')
    ...
    when exp_key is in invalid format. """
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging, mock.patch(
            ...
            self.assertIsNone(self.eyeofcloud.get_variation(99, 'test_user'))
    ...
    when user_id is in invalid format. """
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging:
            self.assertIsNone(self.eyeofcloud.get_variation('test_experiment', 99))
        mock_client_logging.error.assert_called_once_with('Provided "user_id" is in an invalid format.')
    ...
    when exp_key is in invalid format. """
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging, mock.patch(
            ...
            self.assertIsNone(self.eyeofcloud.activate(99, 'test_user'))
    ...
    when user_id is in invalid format. """
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging:
            self.assertIsNone(self.eyeofcloud.activate('test_experiment', 99))
    ...
    def test_activate__invalid_attributes(self):
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging:
            self.eyeofcloud.activate('test_experiment', 'test_user', attributes='invalid')
    ...
    def test_get_variation__experiment_not_running(self):
        ...
        with mock.patch.object(self.eyeofcloud.decision_service, 'logger') as mock_decision_logging, mock.patch(
                'eyeofcloud.helpers.experiment.is_experiment_running', return_value=False
        ) as mock_is_experiment_running:
            self.eyeofcloud.get_variation(
                'test_experiment', 'test_user', attributes={'test_attribute': 'test_value'},
    ...
    def test_get_variation__forced_bucketing(self):
        ...
        self.assertTrue(self.eyeofcloud.set_forced_variation('test_experiment', 'test_user', 'variation'))
        self.assertEqual(
            'variation', self.eyeofcloud.get_forced_variation('test_experiment', 'test_user'),
        )
        variation_key = self.eyeofcloud.get_variation(
            'test_experiment', 'test_user', attributes={'test_attribute': 'test_value'}
        )
    ...
    def test_get_variation__experiment_not_running__forced_bucketing(self):
        ...
        with mock.patch(
            ...
            self.eyeofcloud.set_forced_variation('test_experiment', 'test_user', 'variation')
            self.assertEqual(
                'variation', self.eyeofcloud.get_forced_variation('test_experiment', 'test_user'),
            )
            variation_key = self.eyeofcloud.get_variation(
    ...
    def test_get_variation__whitelisted_user_forced_bucketing(self):
        ...
        self.assertTrue(self.eyeofcloud.set_forced_variation('group_exp_1', 'user_1', 'group_exp_1_variation'))
        forced_variation = self.eyeofcloud.get_forced_variation('group_exp_1', 'user_1')
    ...
    def test_get_variation__user_profile__forced_bucketing(self):
        ...
        with mock.patch(
                'eyeofcloud.decision_service.DecisionService.get_stored_variation',
    ...
    def test_set_forced_variation__invalid_object(self):
        """ Test that set_forced_variation logs error if Eyeofcloud instance is invalid. """
        ...
        mock_client_logging.error.assert_called_once_with(
            'Eyeofcloud instance is not valid. ' 'Failing "set_forced_variation".'
        )
    ...
    def test_set_forced_variation__invalid_config(self):
        ...
        mock_client_logging.error.assert_called_once_with(
            'Invalid config. Eyeofcloud instance is not valid. ' 'Failing "set_forced_variation".'
        )
    ...
    when exp_key is in invalid format. """
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging, mock.patch(
            ...
            self.assertFalse(self.eyeofcloud.set_forced_variation(99, 'test_user', 'variation'))
    ...
    when user_id is in invalid format. """
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging:
            self.assertFalse(self.eyeofcloud.set_forced_variation('test_experiment', 99, 'variation'))
        mock_client_logging.error.assert_called_once_with('Provided "user_id" is in an invalid format.')

    def test_get_forced_variation__invalid_object(self):
        """ Test that get_forced_variation logs error if Eyeofcloud instance is invalid. """
        ...
        mock_client_logging.error.assert_called_once_with(
            'Eyeofcloud instance is not valid. ' 'Failing "get_forced_variation".'
        )
    ...
    def test_get_forced_variation__invalid_config(self):
        ...
        mock_client_logging.error.assert_called_once_with(
            'Invalid config. Eyeofcloud instance is not valid. ' 'Failing "get_forced_variation".'
        )
    ...
    when exp_key is in invalid format. """
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging, mock.patch(
            ...
            self.assertIsNone(self.eyeofcloud.get_forced_variation(99, 'test_user'))
    ...
    when user_id is in invalid format. """
        ...
        with mock.patch.object(self.eyeofcloud, 'logger') as mock_client_logging:
            self.assertIsNone(self.eyeofcloud.get_forced_variation('test_experiment', 99))
    ...
    def test_user_context_invalid_user_id(self):
        ...
        for u in user_ids:
            uc = self.eyeofcloud.create_user_context(u)
