...
from eyeofcloud.helpers import audience
...
class AudienceTest(base.BaseTest):
    ...
    """
        ...
        with mock.patch('eyeofcloud.helpers.condition_tree_evaluator.evaluate') as cond_tree_eval:
    ...
    """
        ...
        with mock.patch('eyeofcloud.helpers.condition.CustomAttributeConditionEvaluator') as custom_attr_eval:
            audience.does_user_meet_audience_conditions(
                self.project_config,
                experiment.get_audience_conditions_or_ids(),
                enums.ExperimentAudienceEvaluationLogs,
    ...
    def test_does_user_meet_audience_conditions__returns_true__when_condition_tree_evaluator_returns_true(self):
        ...
        user_attributes = {'test_attribute': 'test_value_1'}
        experiment = self.project_config.get_experiment_from_key('test_experiment')
        with mock.patch('eyeofcloud.helpers.condition_tree_evaluator.evaluate', return_value=True):
            user_meets_audience_conditions, _ = audience.does_user_meet_audience_conditions(
                self.project_config,
                experiment.get_audience_conditions_or_ids(),
                enums.ExperimentAudienceEvaluationLogs,
    ...
    def test_does_user_meet_audience_conditions_returns_false_when_condition_tree_evaluator_returns_none_or_false(self):
        ...
        user_attributes = {'test_attribute': 'test_value_1'}
        experiment = self.project_config.get_experiment_from_key('test_experiment')
        with mock.patch('eyeofcloud.helpers.condition_tree_evaluator.evaluate', return_value=None):
            user_meets_audience_conditions, _ = audience.does_user_meet_audience_conditions(
                self.project_config,
                experiment.get_audience_conditions_or_ids(),
                enums.ExperimentAudienceEvaluationLogs,
        ...
        with mock.patch('eyeofcloud.helpers.condition_tree_evaluator.evaluate', return_value=False):
            user_meets_audience_conditions, _ = audience.does_user_meet_audience_conditions(
                self.project_config,
                experiment.get_audience_conditions_or_ids(),
                enums.ExperimentAudienceEvaluationLogs,
...
class ExperimentAudienceLoggingTest(base.BaseTest):
    ...
    def test_does_user_meet_audience_conditions__evaluates_audience_ids(self):
        ...
        with mock.patch(
            'eyeofcloud.helpers.condition.CustomAttributeConditionEvaluator.evaluate', side_effect=[None, None],
        ):
            audience.does_user_meet_audience_conditions(
                self.project_config,
                experiment.get_audience_conditions_or_ids(),
    ...
    def test_does_user_meet_audience_conditions__evaluates_audience_conditions(self):
        ...
        with mock.patch(
            'eyeofcloud.helpers.condition.CustomAttributeConditionEvaluator.evaluate', side_effect=[False, None, True],
        ):
            audience.does_user_meet_audience_conditions(
                project_config,
                experiment.get_audience_conditions_or_ids(),
