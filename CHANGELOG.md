# Eyeofcloud Python SDK Changelog
...
* Fix: send impression event for Feature Test when Feature is disabled ([#128](https://github.com/eyeofcloud/python-sdk/pull/128)).
